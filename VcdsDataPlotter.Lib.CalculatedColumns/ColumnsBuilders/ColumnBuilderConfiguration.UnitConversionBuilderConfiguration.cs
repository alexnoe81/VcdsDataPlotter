...
namespace VcdsDataPlotter.Lib.CalculatedColumns.ColumnsBuilders
{
    ...
    {
        private class UnitConversionBuilderConfiguration : ColumnBuilderConfiguration
        {
            public UnitConversionBuilderConfiguration(ColumnBuilderConfiguration parent, string targetUnit) => (this.targetUnit, this.parentBuilderConfiguration) = (
            ...
            public override ColumnBuilderBuildingResult TryBuild(IList<IDiscreteDataColumn> sourceColumns, [NotNullWhen(true)] out IDiscreteDataColumn? result)
            {
                ...
                try
                {
                    result = UnitTransformation.Create(parentColumn!, targetUnit);
                }
            ...
            public override string ToString() => $"Convert unit of '{parentBuilderConfiguration}' to '{targetUnit}'";
